...
confs = [
  ...
  {'name': 'dp_ui_lead_info', 'default': False, 'type': 'Bool', 'conf_type': ['param', 'struct']},
  ...
  {'name': 'dp_lateral_torque_live_tune', 'default': True, 'type': 'Bool', 'conf_type': ['param']},
  ...
  {'name': 'dp_e2e_conditional_adapt_fp', 'default': True, 'type': 'Bool', 'depends': [{'name': 'dp_e2e_conditional', 'vals': [True]}], 'conf_type': ['param', 'struct']},
  {'name': 'dp_e2e_conditional_adapt_ap', 'default': True, 'type': 'Bool', 'depends': [{'name': 'dp_e2e_conditional', 'vals': [True]}], 'conf_type': ['param', 'struct']},
